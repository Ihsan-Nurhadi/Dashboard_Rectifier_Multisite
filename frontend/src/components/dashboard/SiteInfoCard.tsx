      ...
      <div className="grid grid-cols-12 gap-8">
        ...
        <div className="col-span-12 lg:col-span-3 flex flex-col gap-4">
          <div className="p-4 rounded-xl border border-emerald-100 bg-emerald-50/30">
            ...
            <span className={`text-xl font-bold font-mono ${data.statusRealtime === 'Normal' ? 'text-emerald-500' :
              data.statusRealtime === 'Alarm' ? 'text-red-500' : 'text-amber-500'
              }`}>{data.statusRealtime ?? '-'}</span>
          </div>
          ...
          <div className="p-4 rounded-xl border border-amber-100 bg-amber-50/30">
            ...
            <span className={`text-xl font-bold font-mono ${data.statusLadder === 'Normal' ? 'text-emerald-500' : 'text-amber-500'
              }`}>{data.statusLadder ?? '-'}</span>
          </div>
